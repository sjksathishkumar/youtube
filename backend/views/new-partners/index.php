...
<?php \yii\widgets\Pjax::begin(); ?>   
    ...
    <ul>
        ...
        <li><a href="#">Manage New Partners</a></li>
    </ul>
...
<div class="row-fluid">
    ...
    <div class="box box-color box-bordered">
        <div class="box-title">
            <h3><i class="icon-reorder"></i> New Partners</h3>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'urlCreator' => function ($action, $model, $key, $index) {
                            if ($action === 'Approve') {
                                $url ='approve?id='.$model->pkPartnerID;
                               // $url ='controller/action?id='.$model->id;
                                return $url;
                            }
                            if ($action === 'Reject') {
                                $url ='reject?id='.$model->pkPartnerID;
                               // $url ='controller/action?id='.$model->id;
                                return $url;
                            }
                          }
