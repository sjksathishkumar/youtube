            ...
            <div class="box-content nopadding">
                ...
                <div class="fullwidth">
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <?= Html::dropDownList('contractTemplate', null,ArrayHelper::map(Contract::find()->all(), 'pkContractID', 'contractName'), ['id' => 'contractTemplate', 'prompt'=>'Select Template', 'onchange' => 'test()']) ?>
                        </div>
                    </div>
                    <div class="cb"></div>
                </div>
