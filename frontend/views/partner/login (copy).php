			  ...
			  <?php $form = ActiveForm::begin(['id' => 'login-form', 'class'=>'form-validate']); ?>
				<div class="control-group">
					<div class="email controls">
						<?= $form->field($model, 'email')->textInput(['placeholder'=>'Email ID', 'class' => 'input-block-level','size' => 40, 'maxlength' => 150])->label(false); ?>
					</div>
				</div>
				<div class="control-group">
					<div class="pw controls">
						  <?= $form->field($model, 'password')->passwordInput(['placeholder'=>'Password', 'class' => 'input-block-level','size' => 40, 'maxlength' => 150])->label(false); ?>
					</div>
				</div>
